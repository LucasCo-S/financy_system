...
('0001-01', 3500.50, 1, 'Corrente'),
('0002-01', 7800.00, 2, 'Poupança'),
('0003-01', 15000.00, 3, 'Investimento');

INSERT INTO conta_corrente (id_conta, tarifaMensal) VALUES
(1, 25.00);

INSERT INTO conta (numero_Conta, saldo, id_Cliente, tipo_conta) VALUES
('0006-01', 5000.00, 3, 'Poupança'),
('0007-01', 8500.00, 1, 'Poupança');

INSERT INTO conta_poupanca (id_conta, rendimento) VALUES
(2, 0.45);

INSERT INTO conta (numero_Conta, saldo, id_Cliente, tipo_conta) VALUES
('0008-01', 30000.00, 2, 'Investimento'),
('0009-01', 12000.00, 1, 'Investimento');
