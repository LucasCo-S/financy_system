...
SELECT * FROM transacao t INNER JOIN tran_pix p ON t.id_transacao = p.id_transacao;

INSERT INTO tran_pix (id_transacao, chaveOrg, chaveDest) VALUES
(1, 'joao@banco.com', 'maria@banco.com'),
(2, 'investidor@banco.com', 'carlos@banco.com');

INSERT INTO tran_boleto (id_transacao, codBarras, dataVencimento) VALUES
(2, '23793812938120381203120381203120381203812038', '2025-10-20'),
(1, '10493812938120381203120381203120381203812038', '2025-11-10');
